...
import trackingMail from '../../../assets/tracking-mail.png'
import mailsRoute from '../../../assets/ruta-plantillas-mail.png'
...
Y por si lo necesitás como base para tu nueva plantilla, el contenido de la nuestra es:
