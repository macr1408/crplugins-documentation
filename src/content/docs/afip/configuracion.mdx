...
El uso del entorno **Pruebas** aunque es recomendable, es opcional. Por lo que podes instalar el plugin y utilizar el entorno de **Producción**.

:::caution
El entorno de pruebas puede ser mas lento en funcionar, asi que es posible que se vean ciertos errores al generar facturas, pero es normal.
:::
