...
### Activar suscripciones solo si todos los productos pertenecen a una categoría específica
...
### Activar suscripciones solo si no hay productos de ciertas categorías
