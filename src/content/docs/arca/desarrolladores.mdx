...
```php
add_filter( 'wc_afip_automatic_processor_should_process_order', 'crplugins_should_process_order', 10, 3 );
function crplugins_should_process_order( $order, $status_from, $status_to ) {
