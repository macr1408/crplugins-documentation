...
5. Clickear en el logo de ARCA a la izquierda, luego en **Servicios Interactivos** y por último en **Administración de Certificados Digitales** 

6. Confirmamos los datos

7. Volvemos a la pantalla de inicio del sitio de ARCA
...
14. Volvemos a la pantalla de inicio del sitio de ARCA
...
22. Volvemos a la pantalla de inicio del sitio de ARCA
...
25. Clickear en el logo de ARCA a la izquierda, luego en **WebServices** y por último en **Facturación Electrónica**
...
5. Clickear en el logo de ARCA a la izquierda, luego en **Servicios Interactivos** y por último en **WSASS - Autogestión Certificados Homologación** 
